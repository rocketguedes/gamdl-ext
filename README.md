...
- `album_artists`, `artists`, `comment`, `compilation`, `copyright`, `cover`, `gapless`, `genre`, `genre_id`, `isrc`, `language`, `lyrics`, `rating`, `record_label`, `release_date`, `releasetype`, `storefront`, `upc`, `xid`
